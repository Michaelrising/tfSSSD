...
#nohup python3 -u train-csdi.py --algo 'S5' --cuda 1 --stock 'SE'> ../log/stocks/train_csdi_se_s5.log  2>&1 &
...
#nohup python3 -u train-csdi.py --algo 'Mega' --cuda 0 --batch_size 32 --stock 'DJ'  > ../log/stocks/train_csdi_dj_mega.log  2>&1 &

# HK ES
#nohup python3 -u train-csdi.py --algo 'transformer' --cuda 0 --stock 'ES' > ../log/stocks/train_csdi_es_transformer.log  2>&1 & OK
#nohup python3 -u train-csdi.py --algo 'S4' --cuda 0 --stock 'ES' > ../log/stocks/train_csdi_es_s4.log  2>&1 &
nohup python3 -u train-csdi.py --algo 'S5' --cuda 1 --stock 'ES'> ../log/stocks/train_csdi_es_s5.log  2>&1 &
nohup python3 -u train-csdi.py --algo 'Mega' --cuda 0 --batch_size 32 --stock 'ES'  > ../log/stocks/train_csdi_es_mega.log  2>&1 &




# SZ
#nohup python3 -u train-sssd.py --cuda 0 --alg "S4" --stock 'DJ' > ../log/stocks/train_sssd_dj_s4.log  2>&1 &
...
nohup python3 -u train-sssd.py --cuda 0 --alg "S5" --stock 'ES'  > ../log/stocks/train_sssd_es_s5.log  2>&1 &
