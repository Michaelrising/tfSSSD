...
#nohup python3 -u train-sssd.py --cuda 0 --alg "Mega" --stock 'SE' > ../log/stocks/SE/train_sssd_se_mega.log  2>&1 & #
...
nohup python3 -u evaluate_sssd.py --algo 'S5' --cuda 0 --stock 'DJ' > ../log/stocks/DJ/evaluate_sssd_dj_s5.log  2>&1 & #
...
nohup python3 -u evaluate_sssd.py --algo 'S5' --cuda 0 --stock 'ES' > ../log/stocks/ES/evaluate_sssd_es_s5.log  2>&1 & #
nohup python3 -u evaluate_sssd.py --algo 'Mega' --cuda 0 --stock 'ES' > ../log/stocks/ES/evaluate_sssd_es_s5.log  2>&1 &



nohup python3 -u evaluate_sssd.py --algo 'S4' --cuda 0 --stock 'SE' > ../log/stocks/SE/evaluate_sssd_se_s4.log  2>&1 & #
nohup python3 -u evaluate_sssd.py --algo 'S5' --cuda 0 --stock 'SE' > ../log/stocks/SE/evaluate_sssd_se_s5.log  2>&1 &
